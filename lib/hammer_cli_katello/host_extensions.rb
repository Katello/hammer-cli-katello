            ...
            collection :content_view_environments, _('Content View Environments') do
              from :content_view do
                ...
                label _("Content view"), :sets => ['ALL'] do
                  field :id, _("Id"), Fields::Field, :deprecated => true
                  field :name, _("Name"), Fields::Field, :deprecated => true
                  field :composite, _("Composite"), Fields::Boolean, :deprecated => true
                  field :rolling, _("Rolling"), Fields::Boolean, :deprecated => true
                end
