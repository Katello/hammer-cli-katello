            ...
            collection :content_view_environments, _('Content View Environments') do
              from :content_view do
                ...
                label _("Content view"), :sets => ['ALL'] do
                  field :id, _("Id"), Fields::Field, :replaced_by => [_('Content Information'), _('Content View Environments'), _('CV Id')].join('/')
                  field :name, _("Name"), Fields::Field, :replaced_by => [_('Content Information'), _('Content View Environments'), _('CV Name')].join('/')
                  field :composite, _("Composite"), Fields::Boolean, :replaced_by => [_('Content Information'), _('Content View Environments'), _('Composite CV')].join('/')
                  field :rolling, _("Rolling"), Fields::Boolean, :replaced_by => [_('Content Information'), _('Content View Environments'), _('Rolling CV')].join('/')
                end
              ...
              from :lifecycle_environment do
                ...
                label _("Lifecycle environment"), :sets => ['ALL'] do
                  field :id, _("Id"), Fields::Field, :replaced_by => [_('Content Information'), _('Content View Environments'), _('LE Id')].join('/')
                  field :name, _("Name"), Fields::Field, :replaced_by => [_('Content Information'), _('Content View Environments'), _('LE Name')].join('/')
                end
