  ...
  describe Hostgroup do
    ...
    describe CreateCommand do
      ...
      it 'allows content view name' do
        ...
        api_expects(:hostgroups, :create) do |p|
          p['hostgroup']['content_view_id'] == 3 && p['hostgroup']['name'] == 'hg1'
        end
        run_cmd(%w(hostgroup create --name hg1 --content-view cv3 --organization-ids 1))
      end
      ...
      it 'allows lifecycle environment name' do
        ...
        api_expects(:hostgroups, :create) do |p|
          p['hostgroup']['name'] == 'hg1' && p['hostgroup']['lifecycle_environment_id'] == 3
        end
        run_cmd(%w(hostgroup create --name hg1 --lifecycle-environment le1 --organization-ids 1,2))
      end

      it 'allows environment id' do
        api_expects(:hostgroups, :create) do |p|
          p['hostgroup']['name'] == 'hg1' && p['hostgroup']['environment_id'] == 1 &&
            p['hostgroup']['organization_ids'] == %w(1 2)
        end
        run_cmd(%w(hostgroup create --name hg1 --environment-id 1 --organization-ids 1,2))
      end

      it 'allows content view and lifecycle IDs' do
        api_expects(:hostgroups, :create) do |p|
          p['hostgroup']['name'] == 'hg1' && p['hostgroup']['lifecycle_environment_id'] == 4 &&
            p['hostgroup']['content_view_id'] == 2
        end
        run_cmd(%w(hostgroup create --name hg1 --lifecycle-environment-id 4
      ...
      it 'allows content view ID and lifecycle name' do
        ...
        run_cmd(%w(hostgroup create --name hg1 --lifecycle-environment le4
                   --organization-ids 1,2 --content-view-id 2))
      end
